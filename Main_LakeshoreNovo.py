...
def NC_savedata(**kwargs):
    ...
    if NC.DCbias == '1': 
        fname =  timeanddate+'_'+sample.name_entry.get()+'_'+str(NC.ACvolt)+'Vac_'+str(NC.DCvolt)+'Vdc'
    else:
        fname =  timeanddate+'_'+sample.name_entry.get()+'_'+str(NC.ACvolt)+'V_'
    ...
    if mea_type == 'continuous':
        ...
        if mea_type == 'single':
            ...
            fname = fname+str(nowtemp.value)+'K'
...
def NC_savedata_Continuous(**kwargs):
    ...
    if DCbias == '1': 
        fname =  timeanddate+'_'+sample.name_entry.get()+'_'+str(ACvolt)+'Vac_'+str(DCvolt)+'Vdc'
    else:
        fname =  timeanddate+'_'+sample.name_entry.get()+'_'+str(ACvolt)+'V_'
